...
- **結果**: `app/src/main/kotlin/tools/isekai/terminal/session/TerminalSession.kt` の
...
- `app/src/main/kotlin/tools/isekai/terminal/session/TerminalSession.kt`: `notifyNetworkLost()`
- `app/src/main/kotlin/tools/isekai/terminal/TerminalViewModel.kt`: `notifyNetworkLost()` の呼び出し元

...
//!   (`spawn_app_ack_tasks`), ported from `helper_quic_transport.rs`'s
...
//!   the C2H replay buffer/backpressure, `ISEKAI_SSH_DESIGN.md`'s task
//!   split).
//!
...
// bookkeeping (`ISEKAI_SSH_DESIGN.md` Phase S-4c task split).

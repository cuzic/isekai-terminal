...
//!
//! This module implements the traits defined in h3-datagram for the noq crate.
//! Direct port of `h3-quinn`'s `datagram.rs`; noq's `Connection::send_datagram`/
//! `read_datagram`/`SendDatagramError` are API-identical to quinn's.

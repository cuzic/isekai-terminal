...
public func synthesizeDisplayUpdate(
    ...
    return ScreenUpdate(
        ...
        notifyGeneration: update.notifyGeneration,
        notifyKind: update.notifyKind,
        notifyTitle: update.notifyTitle,
        notifyBody: update.notifyBody,
        panelGeneration: update.panelGeneration,
        panelKind: update.panelKind,
        panelTitle: update.panelTitle,
        panelMarkdown: update.panelMarkdown,
        panelFields: update.panelFields,

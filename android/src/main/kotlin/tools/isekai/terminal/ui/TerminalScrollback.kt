...
fun synthesizeDisplayUpdate(
    ...
    return ScreenUpdate(
        ...
        notifyGeneration = live.notifyGeneration,
        notifyKind = live.notifyKind,
        notifyTitle = live.notifyTitle,
        notifyBody = live.notifyBody,
        panelGeneration = live.panelGeneration,
        panelKind = live.panelKind,
        panelTitle = live.panelTitle,
        panelMarkdown = live.panelMarkdown,
        panelFields = live.panelFields,

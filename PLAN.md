...
- ✅ **Phase 0-1（Swiftバインディング生成の検証、最大のリスク項目）**: 新規
  ...
  `app/src/main/kotlin/uniffi/isekai_terminal_core/isekai_terminal_core.kt` の運用と対称）。
...
- **Kotlinバインディング(`app/src/main/kotlin/uniffi/isekai_terminal_core/isekai_terminal_core.kt`)は
...
- `lib.rs`に`pub mod session_supervisor;`と
  ...
  を追加。Kotlinバインディング(`app/src/main/kotlin/uniffi/isekai_terminal_core/isekai_terminal_core.kt`)
